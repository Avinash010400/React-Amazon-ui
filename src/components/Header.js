          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white ">
                Hotline:
                <a className="text-decoration-none text-white" href='"tel:+91 8908130394'>
                  +91 8908130394
                </a>
              </p>
            </div>
      ...
      <header className="header-upper py-3">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <h2>
                <Link className="text-decoration-none text-white">Developers.</Link>
              </h2>
            </div>
            <div className="col-5">
                ...
                <div>
                  <Link to="/cart" className="d-flex align-items-center gap-10 text-white text-decoration-none">
                    ...
                    <div className="d-flex flex-column gap-10">
                      ...
                      <p className="mb-0 text-decoration-none">$ 000</p>
                    </div>
                  </Link>
                </div>
              </div>
