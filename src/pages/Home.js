...
<p className="text-dark">27-inch 5k retina dispay</p>
</div>
</div>
</div>
<div className="col-3">
...
<p className="text-dark">Now is green. from $999.00 or $41.62/mo. for 24 mo.</p>
</div>
</div>
</div>
<div className="col-3">
...
<SpecialProduct/>
      ...
      <section className="popular-wrapper py-5 home-wrapper">
<div className="container-xxl">
  <div className="row">
    <div className="col-12">
<h3 className="section-heading">
